...
4. For API details, consult the generated Javadoc (https://jitpack.io/com/github/forax/lazylr/latest/javadoc/).
5. [src/test/java/...](src/test/java) for executable examples.
