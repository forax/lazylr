...
///   it calls [#evaluate(Terminal, int)] to convert the raw token into a value
...
/// The parser may be reused normally with another input after an evaluation exception.
///
...
public interface Evaluator<T extends @Nullable Object> {
  ...
  T evaluate(Terminal terminal, int position);
